    ...
    $('#buttons .btn').on('click', function () {
        ...
        function createDragableArea () {
            ...
            function moveRexonaBottle_m (e) {
                e.preventDefault();
                var x = (e.originalEvent.touches[0].pageX || e.originalEvent.changedTouches[0].pageX) - 90;
                var y = (e.originalEvent.touches[0].pageY || e.originalEvent.changedTouches[0].pageY) - 150;
