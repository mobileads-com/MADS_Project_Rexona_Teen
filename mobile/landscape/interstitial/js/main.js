...
Ad.prototype.createLastScreen = function (parent) {
    ...
    $('#girls').show().removeClass('first-screen').addClass('last-screen');
    $('#rexona-logo').removeClass('third-screen').addClass('last-screen');
...
Ad.prototype.renderFirstScreen = function () {
    ...
    firstScreen.append(girls);
    girls.addClass('first-screen');
    firstScreen.append(logo);
    logo.addClass('first-screen');
...
Ad.prototype.renderSecondScreen = function (config) {
    ...
    $('#buttons .btn').on('click', function () {
        ...
        $('#buttons .btn').hide();
        $('#girls').hide();
        $('#rexona-logo').removeClass('first-screen').addClass('second-screen');
        ...
        function createDragableArea () {
            ...
            function moveRexonaBottle_m (e) {
                e.preventDefault();
                var x = (e.originalEvent.touches[0].pageX || e.originalEvent.changedTouches[0].pageX) - 50;
                var y = (e.originalEvent.touches[0].pageY || e.originalEvent.changedTouches[0].pageY) - 50;
    ...
    if (this.selectedCharacter == "bonnie") {
        if (!$('#bonnie-video-3rd-screen').length) {
            ...
            bonnieVideo.onPlayerStateChange = function (e) {
                ...
                $('#rexona-logo').fadeIn().removeClass('second-screen').addClass('third-screen');
            };
